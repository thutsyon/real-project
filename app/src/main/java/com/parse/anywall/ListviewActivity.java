...
/**
 * Created by xueguanglu on 8/20/15.
 */
public class ListviewActivity extends FragmentActivity implements LocationListener,
   ...
   */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.action_mapview).setOnMenuItemClickListener(new OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
